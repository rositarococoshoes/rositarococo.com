      ...
      if (success) {
        ...
        button.innerHTML = `
          <svg class="w-5 h-5 mr-2 inline animate-spin" fill="none" viewBox="0 0 24 24">
            ...
            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 0114 12c0 1.79-.425 3.48-1.188 4.793l1.347 1.347A8.002 8.002 0 0012 20.588a8.002 8.002 0 0011.653-2.291z"></path>
          </svg>
          Agregando...
        `;
